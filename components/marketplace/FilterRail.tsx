...
const CATEGORIES: { value: ProductCategory; label: string; subcategories: string[] }[] = [
  ...
  { value: 'shoes', label: 'Shoes', subcategories: ['Sneakers', 'Boots', 'Heels', 'Sandals', 'Flats'] },
  { value: 'accessories', label: 'Accessories', subcategories: ['Jewelry', 'Watches', 'Sunglasses', 'Hats', 'Scarves'] },
  { value: 'bags', label: 'Bags', subcategories: ['Backpacks', 'Handbags', 'Crossbody', 'Totes', 'Clutches'] },
