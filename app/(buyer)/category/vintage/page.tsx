          ...
          <div className="flex items-center justify-between mb-6 pb-4 border-b border-[var(--divider)]">
            <div className="flex items-center gap-4">
              <button
                ...
                className="md:hidden flex items-center gap-2 px-4 py-2 border border-[var(--border)] rounded-lg hover:bg-[var(--surface-2)] transition-colors"
              >
            ...
            <select
              ...
              className="px-4 py-2 border border-[var(--border)] rounded-lg bg-[var(--surface)] text-sm font-medium focus:outline-none focus:ring-2 focus:ring-[var(--brand)] transition-all"
            >
