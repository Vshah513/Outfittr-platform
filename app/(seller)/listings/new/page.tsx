...
export default function NewListingPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    subcategory: '',
    size: '',
    condition: 'brand_new',  // Changed default from 'good' to 'brand_new' for better UX
    brand: '',
  ...
  useEffect(() => {
    if (formData.condition === 'new' as any) {
      setFormData({ ...formData, condition: 'brand_new' });
    }
  }, []);
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-sm text-vintage-secondary mt-1">
                List your item in 3 simple steps
              </p>
            </div>
          </div>
